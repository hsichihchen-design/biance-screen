...
def main():
    ...
    # 標題與更新時間合併為單一欄位
    st.markdown(f"""
        <div style='display: flex; justify-content: space-between; align-items: baseline; border-bottom: 2px solid #000000; padding-top: 20px; padding-bottom: 5px; margin-bottom: 10px;'>
